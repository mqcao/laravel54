<?php
return [ /* |-------------------------------------------------------------------------- | Validation Language Lines |-------------------------------------------------------------------------- | | The following language lines contain the default error messages used by | the validator class. Some of these rules have multiple versions such | as the size rules. Feel free to tweak each of these messages here. | */
    ...
    'between' => [ 'numeric' => '注意: :attribute 必须在 :min 至 :max 之间.',
    ...
    'exists' => '注意: 选中的 :attribute 不可用.', 'file' => '注意: :attribute 必须为一个文件.',
    ...
    'max' => [ 'numeric' => '注意: :attribute 不可以比 :max 大.',
    ...
    'min' => [ 'numeric' => '注意: :attribute 必须最小为 :min.',
    ...
    'size' => [ 'numeric' => '注意: :attribute 必须 :size.',
    ...
    'zh_mobile' => '注意: :attribute 不是有效的电话号码.', ];